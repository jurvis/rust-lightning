		...
		let route = Route {
			paths: vec![vec![
					RouteHop {
						...
						short_channel_id: 0, fee_msat: 0, cltv_expiry_delta: 0, path_penalty_msat: 0, // Test vectors are garbage and not generateble from a RouteHop, we fill in payloads manually
					},
					RouteHop {
